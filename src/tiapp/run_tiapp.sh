...
BASEDIR=$HOME/courses/comp512/A2/comp512p2
...
export process1=open-gpu-16:401$group
export process2=open-gpu-16:402$group
export process3=open-gpu-16:403$group
